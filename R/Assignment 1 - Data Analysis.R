#' Assignment1
#'
#' Cleans data from three sources
#' @param audubon_data the csv file from audubon
#' @param gw_data the csv file from gw
#' @param nat_geo_data the csv file from nat geo
#' @keywords clean
#' @export
